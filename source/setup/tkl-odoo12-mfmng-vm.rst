...
.. index:: tkl-odoo12-mfmng-vm

.. index:: CLVsol-FMmng Local Server creation (development)

==================================================
*CLVsol-FMmng* Local Server creation (development)
==================================================

This project will help you create a server to host the **Odoo 12 (CLVsol-MFMng)** solution, based on an `Odoo <https://www.odoo.com/>`_  appliance, using the VMWare Workstagion infrastructure.
...
--------
    ...
    .. glossary::
       ...
       `tkl-odoo12-mfmng-vm <https://tkl-odoo12-mfmng-vm>`_
          Name of the Turnkey Linux Server.

       `clvsol_odoo_addons (12.0) <https://github.com/CLVsol/clvsol_odoo_addons/tree/12.0>`_
          CLVsol Odoo Addons.

       `clvsol_odoo_addons_mfmng (12.0) <https://github.com/CLVsol/clvsol_odoo_addons_mfmng/tree/12.0>`_
          CLVsol Odoo Addons - JCAFB customizations.

       `clvsol_mfmng (12.0) <https://github.com/CLVsol/clvsol_mfmng/tree/12.0>`_
          Implemantation of CLVsol-FMmng, the CLVsol Health Management solution for JCAFB.
