...
====================================================================================
[2020-02-28] - Migração do banco de dados mfmng_12 - servidor [tkl-odoo12-mmfmng-vm]
====================================================================================

Criar uma nova instância do banco de dados **mfmng_12** (2020-02-28)
--------------------------------------------------------------------
...
.. _Lista de Schedules 20200228:

Lista de *Schedules* instalados (2020-02-28)
--------------------------------------------
...
Executar o *External Sync Batch* "*Default Batch*" (2020-02-28)
---------------------------------------------------------------
    ...
    #. [tkl-odoo12-mfmng-vm] Configurar os :bi:`External Sync Schedules` :green:`Novos`:
        ...
        #. Configurar, com a ajuda da ação :bi:`External Sync Schedule Mass Edit`, os :bi:`External Sync Schedules` :green:`Novos`:
            ...
            * Lista de *Schedules*:
                * :ref:`Lista de Schedules 20200228`
    ...
    #. [tkl-odoo12-mfmng-vm] Executar o :bi:`External Sync Batch` "**Default Batch**":
        ...
        #. Executar a ação :bi:`External Sync Batch Exec` para o "**Default Batch**":
            ...
            * *Synchronization Log*:
                * :ref:`External Sync Batch - Default Batch - 20200228`
